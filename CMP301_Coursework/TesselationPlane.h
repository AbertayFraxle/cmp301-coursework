...
#ifndef _TESSELLATIONPLANE_H_
#define _TESSELLATIONPLANE_H_
...
public:
	TessellationPlane(ID3D11Device* device, ID3D11DeviceContext* deviceContext, float length, float width);
	~TessellationPlane();
...
protected:
	void initBuffers(ID3D11Device* device, float length, float width);
